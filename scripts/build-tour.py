...
FEATURES = [
    ...
    ("progress.png", "left", "See exactly what's left",
     "Hours logged week by week, a checklist of every requirement &mdash; pass mark, goal, each write-up count, every boiler and fault &mdash; and a nudge when something looks off, like a day with too many hours or an engineer's Gas&nbsp;Safe card that's run out.",
     ["Weekly hours history", "What&#8209;s&#8209;left checklist", "Card&#8209;expiry warnings"]),
    ("job-log.png", "right", "A running total for every entry you've ever logged",
     "Every hours and write-up entry, oldest first, numbered, with a running hours total next to each one &mdash; your starting hours included as the first line. It's built from the log itself, so it's always current.",
